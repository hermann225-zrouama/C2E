    ...
    <div class="resume-wrapper">
      <section class="profile section-padding">
        <div class="container">
          ...
          <div class="contact-info clearfix">
            ...
            <v-btn
              v-if="u_data.photo == ''"
              :href="'/#/profile/'+u_data._id+'/parametre'"
            >mettre une photo de profil</v-btn>
            <v-btn
              v-if="exp.length != 0"
              :href="'/#/profile/'+u_data._id+'/parametre'"
            >Ajouter une experience</v-btn>
          </div>
        </div>
      </section>
      <section class="experience section-padding">
        <div class="container">
          ...
          <div v-if="exp.length != 0" class="experience-wrapper">
          ...
          <div v-else>
            <v-alert color="blue-grey" dark dense icon="mdi-school" prominent>
              <v-row align="center">
                ...
                <v-col class="shrink">
                  <v-btn @click="set_nav()" :href="'/#/profile/'+u_data._id+'/parametre'">ajouter</v-btn>
                </v-col>
              </v-row>
            </v-alert>
          </div>
...
export default {
  ...
  methods: {
    set_nav() {
      localStorage.setItem("bottomNav", 0);
    }
  },
  computed: {
    u_data() {
    ...
    exp() {
      return this.$store.getters.exp_data;
    }
  }
};
</script>
